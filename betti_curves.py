...
class betti_curves(object):
    ...
    '''
    def __init__(self, input_mat1:np.ndarray, input_mat2:np.ndarray = None, corr_type:str = 'betti', **kwargs):
        '''
        Parameters
        ----------
    ...
    def _PopulationVectorMatrix(self):
        ...
        PVCResults[np.where(np.isnan(PVCResults))] = 0
    ...
    def _PearsonMatrix(self):
        ...
        PearsonResults[np.where(np.isnan(PearsonResults))] = 0
